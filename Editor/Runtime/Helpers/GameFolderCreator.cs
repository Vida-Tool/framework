...
public class GameFolderCreator : MonoBehaviour
{
    public static void Create()
    {
        ...
        // Alt klasörler
        string[] altKlasorler = new string[] { "Prefabs", "Scripts", "Materials", "Textures", "Animations", "Audio", "Fonts", "Models", "Scenes", "Shaders", "Sprites" };
