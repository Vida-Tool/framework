        ...
        private void ScriptableObjectTester()
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.BeginVertical(background2);
                {
                    ...
                    DrawLabelBox("LightBorderColor", Style.LightBorderColor,Style.TextOther, (c) => Style.LightBorderColor = c);
                    DrawLabelBox("DarkBorderColor", Style.DarkBorderColor,Style.TextOther, (c) => Style.DarkBorderColor = c);
                }
                GUILayout.EndVertical();
