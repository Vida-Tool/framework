...
namespace Vida.Framework.Editor
{
    ...
    {
        private const string PackageDirectory = "Starters";
        ...
        private async Task LoadPackagesAsync(bool forceRefresh)
        {
            ...
            try
            {
                _packages = await GithubConnector.GetStarterPackagesAsync(forceRefresh);
        ...
        private async Task RefreshPackagesAsync()
        {
            ...
            try
            {
                _packages = await GithubConnector.GetStarterPackagesAsync(true);
                _errorMessage = null;
            }
            catch (System.Exception ex)
            {
